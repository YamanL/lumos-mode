...
namespace LibraryMS.Controllers
{
    public class PurchaseController : Controller
    {
        ...
        public ActionResult DeleteConfirm(int? id)
        {
            ...
            ViewBag.Message = "Some Unexpected issue is occured, Please contact to concerned Person!";
        ...
        public ActionResult CancelPurchase()
        {
            ...
            ViewBag.Message = "Some Unexpected Issue has been occured, Please Contact to the Concerned Personnel";
            return RedirectToAction("NewPurchase");
        }
        ...
        public ActionResult PurchaseConfirm(FormCollection collection)
        {
            ...
            foreach (var name in keys)
            {
                if (name.Contains("name"))
                {
                    ...
                    supplierid = Convert.ToInt32(valueids[0]);
            ...
            ViewBag.Message = "Purchase Confirmed Successfully!";
